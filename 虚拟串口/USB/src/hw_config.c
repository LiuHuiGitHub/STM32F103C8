...
LIB_QUEUE m_QueueUsbComRx;
LIB_QUEUE m_QueueUsbComTx;
uint8_t  m_UsbComRxBuf[USB_COM_RX_BUF_SIZE]      = {0};
uint8_t  m_UsbComTxBuf[USB_COM_TX_BUF_SIZE]      = {0};
...
void Set_System(void)
{
    ...
    uLib_QueueCreate(&m_QueueUsbComRx, m_UsbComRxBuf, 1, USB_COM_RX_BUF_SIZE);
    uLib_QueueCreate(&m_QueueUsbComTx, m_UsbComTxBuf, 1, USB_COM_TX_BUF_SIZE);
...
{
    return uLib_QueueOut(&m_QueueUsbComRx, buffter, buffterSize);
}
/*******************************************************************************
...
{
    return uLib_QueueIn(&m_QueueUsbComRx, buffter, writeLen);
}
/*******************************************************************************
...
{
    return uLib_QueueOut(&m_QueueUsbComTx, buffter, buffterSize);
}
/*******************************************************************************
...
{
    return uLib_QueueIn(&m_QueueUsbComTx, buffter, writeLen);
}
